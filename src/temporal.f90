  ...
  contains
    ...
    subroutine solve_steady(this,epsln)
      ...
      if (this%is_visc.eq..true.) then
        ...
        call compute_max_timesteps_inv(this%grid,this%g,this%R,this%cfl,this%winfty)
      end if
      ...
      if (this%is_visc.eq..true.) then
        ...
        do while (k<(this%niter+this%niterfo))
        ...
        ! Switching to second-order spatial accuracy
        !do while ((any(eqn_resids(k-1,:)>this%tol)).and.(k<(this%niter+this%niterfo)))
        do while (k<(this%niter+this%niterfo))
